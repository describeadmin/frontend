...
import { execa } from '@describeadmin/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreDependencies: [
    '@iconify/json',
    '@describeadmin/core-design',
    '@describeadmin/commitlint-config',
    '@describeadmin/eslint-config',
    '@describeadmin/stylelint-config',
    '@describeadmin/tailwind-config',
    '@describeadmin/vite-config',
    '@describeadmin/oxlint-config',
    'playwright',
    'rimraf',
    'tailwindcss',
  ],
