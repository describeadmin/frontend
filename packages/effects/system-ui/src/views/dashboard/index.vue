 ...
 *
 * 这个页面随 system-ui 一起打包，而不是留在应用外壳里：它展示的四项统计完全来自
 * framework-system-starter 的实体，且 seed-rbac.sql 把它登记为登录后必须存在的
 * 首页路由（component = 'dashboard/index'），本质上是框架基础设施，不是业务内容。
 */
