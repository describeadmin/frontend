...
import type { TreeProps } from '@describeadmin/core-shadcn-ui';

import { Inbox } from '@describeadmin/icons';
import { $t } from '@describeadmin/locales';

import { treePropsDefaults, VbenTree } from '@describeadmin/core-shadcn-ui';
