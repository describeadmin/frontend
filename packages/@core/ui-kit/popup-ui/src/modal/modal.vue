...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@describeadmin/core-composables';
import { Expand, Shrink } from '@describeadmin/core-icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@describeadmin/core-shared/constants';
